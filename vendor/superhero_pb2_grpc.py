...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in superhero_pb2_grpc.py depends on'
...
class SuperHeroServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SearchHero = channel.unary_unary(
...
def add_SuperHeroServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SearchHero': grpc.unary_unary_rpc_method_handler(
                    servicer.SearchHero,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'superhero.SuperHeroService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('superhero.SuperHeroService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class SuperHeroService(object):
    """The gRPC service definition
    """

    @staticmethod
    def SearchHero(request,
            target,
            options=(),
